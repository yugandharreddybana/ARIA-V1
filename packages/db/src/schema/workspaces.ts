...
export const workspaces = pgTable('workspaces', {
  ...
  // ── Onboarding state ──────────────────────────────────────────────────────
  // Null = onboarding not yet completed. Set to NOW() when user clicks
  // "Create Company" in Step 6. Used by middleware to redirect to /onboarding.
  ...
  // ── LLM / model configuration (Step 2) ───────────────────────────────────
